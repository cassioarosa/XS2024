...
| GAP | **Equilíbrio**: Grande deslocamento de baixa 780 pts, **momentum de baixa**. Considerando os deslocamento incomum Alto e Baixo serão tratados como indeterminado.
...
| B05 | Equilíbrio: Continuidade do movimento de correção, nova máxima, bom deslocamento **incremento do momentum de alta**. Compradores fizeram 1X1, boa amplitude de correção compradora (Macro Intraday). Possível considerar **Baixo B1** **Alto B96**.
