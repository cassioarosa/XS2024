...
| Barra | Leitura
|-------|-----
| Pre-Market HTF | **1D Macro** Alternância de Intenção, **Equilíbrio** dissipação de Momentum de Alta, Preço se deslocou para baixo em Região de Valor para Compradores.
...
| B01 | Equilíbrio: Dissipação de Momentum de Alta, após negociação em terço superior, **Momentum de Baixa**
| B02 | 
| B03 |
| B04 |
| B05 |
