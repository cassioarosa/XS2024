...
| B05 | Equilíbrio: Nada Muda. Micro compradores atuaram em valor, apos momentum de alta. Possível Scalp 1X1 Stop na Mínima B3 Alto máxima do dia.
| B06 | Equilíbrio: Bom deslocamento de alta **momentum de alta** mas próximo à máxima do dia. Terço inferior da lateralidade, bom momentum para uma compra, mas ruin estruturação para 2X1. Micro continuidade do movimento
...
| B15 | Equilíbrio: **Dissipação de momentum de alta**, grande deslocamento de preço na baixa, **momentum de baixa**, indicação de que movimento prévio foi uma possível de aceleração para localizar vendedores. Micro troca de intenção para equilíbrio.
...
| B19 | Equilíbrio: **Dissipação de momentum de baixa**, **momentum de alta**
...
| Barra | Leitura
|-------|-----
| Pre-Market Macro | **1D Macro** **Desequilíbrio Forte Comprador** após rompimento da lateralidade, retomada de momentum comprador, maior deslocamento de todo o período, sequência de 4 dias de alta com pequeno deslocamento de preço
